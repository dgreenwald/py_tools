...
- Add typed Slurm job, array, script-generation, and submission helpers in
  `py_tools.cluster`.
...
- Add an optional, versioned canonical schema for loading and combining
  loan-level HMDA data from 1990 onward.
