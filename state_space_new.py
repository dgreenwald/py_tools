...
class MatrixOrList:
    ...
    def __matmul__(self, y):
        ...
        if self.is_list:
            z = [x_t @ y_t for x_t, y_t in zip(self.x, y)]
        else:
            z = [self.x @ y]
...
class StateSpaceModel:
    ...
    # def A(self, tt):
    #     return get_t(self.A_, tt)
    
    # def R(self, tt):
    #     return get_t(self.R_, tt)
    
    # def Q(self, tt):
    #     return get_t(self.Q_, tt)
    
    # def Z(self, tt):
    #     return get_t(self.Z_, tt)
        
    # def H(self, tt):
    #     return get_t(self.H_, tt)
